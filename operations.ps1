...
3. Task List (Read/Write): ./AIAgentsCompany/operations/operations_tasks.csv.
...
1.1.1. Immediately generate a new task and add it to ./AIAgentsCompany/operations/operations_tasks.csv.
...
Read ./AIAgentsCompany/operations/operations_tasks.csv and count the number of tasks with a Status of "Approved" or "In Progress".
...
3. Task Creation:
3.1. Add new task proposals to ./AIAgentsCompany/operations/operations_tasks.csv. BE SURE YOU DON'T REMOVE ANY ANY TASK FROM THE LIST.
