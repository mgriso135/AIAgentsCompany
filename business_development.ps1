# This is the PowerShell script for the Business Development Manager Agent
...
2.1. Market Trend Surveillance: Proactively research and monitor macro and micro market trends relevant to the company's scope as defined in ./AIAgentsCompany/GEMINI.md.
...
3.3. Action: If identical description found, log to Personal Memory (`./AIAgentsCompany/bizdev/bizdev_memory.md`) with timestamp; halt task generation for this opportunity. Do not create task.
